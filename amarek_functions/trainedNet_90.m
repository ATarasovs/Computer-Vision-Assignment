...
function[trained_net] = trainedNet_90()

    %create labels for images, 0=manmade, 1=natural
    labels_training(1:400,1)=0;
    labels_training(401:800,1)=1;
    ...
    imds_training=imageDatastore({'U:\CV assignment\Images\val_test\manmade_training','U:\CV assignment\Images\val_test\natural_training'});
    ...
    %train the network
    trained_net = trainNetwork(imds_training,layers,options);
end
